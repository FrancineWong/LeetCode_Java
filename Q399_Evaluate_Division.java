...
public class Q399_Evaluate_Division {
	...
	private double dfs(String start, String end, Map<String, ArrayList<String>> pairs, Map<String, ArrayList<Double>> valuePair, HashSet<String> set, double value ){
		...
		for(int i=0; i<strList.size(); i++) {
			tmp = dfs(strList.get(i), end, pairs, valuePair, set, value*valueList.get(i));
			if(tmp!=0.0) break;
		}
		set.remove(start);
		return tmp;
