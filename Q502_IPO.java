...
public class Q502_IPO {
	...
	Create (capital, profit) pairs and put them into PriorityQueue pqCap. This PriorityQueue sort by capital 
	increasingly.
	...
	Time Complexity: For worst case, each project it will be only inserted and polled from both PriorityQueues once,
	 the overall runtime complexity should be O(NlgN), N is number of projects.*/
